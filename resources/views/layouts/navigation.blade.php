        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    <x-nav-link :href="route('bloglist.index')" :active="request()->routeIs('bloglist.*')">
                        {{ __('Blogs') }}
                    </x-nav-link>
                    ...
                    <x-nav-link :href="route('enquiry.index')" :active="request()->routeIs('enquiry.*')">
                        {{ __('Enquiry') }}
                    </x-nav-link>
                    <x-nav-link :href="route('testimornials.index')" :active="request()->routeIs('testimornials.*')">
                        {{ __('Testimornial') }}
                    </x-nav-link>
