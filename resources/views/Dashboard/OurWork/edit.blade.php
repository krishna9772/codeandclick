            ...
            <div style="width: 800px;" class="bg-white mx-auto p-4 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <form action="{{ route('our-work.update',$ourwork->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                        <input type="text" name="title" id="title" class="border rounded w-full p-2 {{ $errors->has('title') ? 'border-red-500' : 'border-gray-300' }}" value="{{ old('title',$ourwork->title) }}" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                        <textarea name="content" id="content" class="border h-[200px] rounded w-full p-2 {{ $errors->has('content') ? 'border-red-500' : 'border-gray-300' }}" required>{{ old('content',$ourwork->content) }}</textarea>
                    </div>
                    ...
                    <div class="mb-6">
                        ...
                        <div class="mt-1">
                            <label for="workImages" class="cursor-pointer bg-white py-2 px-3 border border-gray-300 rounded-md shadow-sm text-sm leading-4 font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 inline-block">
                                ...
                                <input id="workImages" name="workImages[]" type="file" class="sr-only" accept="image/*" multiple onchange="previewWorkImages(this)">
                            </label>
