                ...
                <form action="{{ route('our-work.store') }}" method="POST" enctype="multipart/form-data" id="ourWorkForm" novalidate>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                            <textarea name="content_mm" id="content_mm" class="border h-[200px] rounded w-full p-2 {{ $errors->has('content_mm') ? 'border-red-500' : 'border-gray-300' }}">{{ old('content_mm') }}</textarea>
                        </div>
                    </div>
