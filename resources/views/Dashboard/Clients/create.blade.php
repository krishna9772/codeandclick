<x-app-layout>
    <x-slot name="header">
        <a href="{{ route('clients.index') }}" class="border border-blue-800 text-blue-800 font-bold py-2 px-4 rounded">
            ...
            <div style="width: 800px;" class="bg-white mx-auto p-4 overflow-hidden shadow-sm sm:rounded-lg">
              <form action="{{ route('clients.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="name" id="title" class="border border-gray-300 rounded w-full p-2" required>
                    </div>
