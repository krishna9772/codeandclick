    ...
    <div class="py-12">
        <div class="max-w-7xl space-y-6 mx-auto sm:px-6 lg:px-8">
            <div style="width: 800px;" class="bg-white mx-auto p-4 overflow-hidden shadow-sm sm:rounded-lg">
                ...
                @endif
                <form action="{{ route('services.update',$service->id) }}" method="POST" enctype="multipart/form-data" id="serviceForm" novalidate>
                    @csrf
                    @method("PUT")
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                        <input type="text" name="name" id="name" maxlength="255" class="border border-gray-300 rounded w-full p-2" required value="{{ old('name',$service->name) }}">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                        <input type="text" name="title" id="title" maxlength="255" class="border rounded w-full p-2 {{ $errors->has('title') ? 'border-red-500' : 'border-gray-300' }}" value="{{ old('title',$service->title) }}" required>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                        <textarea rows="10" name="main_content" id="main_content" class="border rounded w-full p-2 {{ $errors->has('main_content') ? 'border-red-500' : 'border-gray-300' }}" required data-required-message="The main content field is required.">{{ old('main_content',$service->main_content) }}</textarea>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="hidden" name="tags" value="{{old('tags',$service->tags)}}" id="tags" required data-required-message="The tags field is required.">
                        <p class="mt-1 text-sm text-gray-500">Add at least one tag.</p>
                        <div id="tagList" class="py-2 flex flex-wrap gap-2"></div>
                    </div>

                    <div class="mb-4">
                        <label for="preview" class="block text-gray-700 font-bold mb-2">Sub Content</label>
                        @error('sub_content')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
                        <textarea name="sub_content" id="sub_content" class="border h-[200px] rounded w-full p-2 {{ $errors->has('sub_content') ? 'border-red-500' : 'border-gray-300' }}" required data-required-message="The sub content field is required.">{{ old('sub_content',$service->sub_content) }}</textarea>
                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        ...
                        <div class="mb-4">
                            ...
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                            <input type="text" name="name_mm" id="name_mm" maxlength="255" class="border border-gray-300 rounded w-full p-2" value="{{ old('name_mm',$service->name_mm) }}">
                        </div>
                        <div class="mb-4">
                            ...
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                            <input type="text" name="title_mm" id="title_mm" maxlength="255" class="border rounded w-full p-2 {{ $errors->has('title_mm') ? 'border-red-500' : 'border-gray-300' }}" value="{{ old('title_mm',$service->title_mm) }}">
                        </div>
                        <div class="mb-4">
                            ...
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                            <textarea rows="10" name="main_content_mm" id="main_content_mm" class="border rounded w-full p-2 {{ $errors->has('main_content_mm') ? 'border-red-500' : 'border-gray-300' }}">{{ old('main_content_mm',$service->main_content_mm) }}</textarea>
                        </div>
                        <div class="mb-4">
                            ...
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                            <textarea name="tags_mm" id="tags_mm" class="border rounded w-full p-2 {{ $errors->has('tags_mm') ? 'border-red-500' : 'border-gray-300' }}" placeholder="Use / between each tag">{{ old('tags_mm',$service->tags_mm) }}</textarea>
                        </div>
                        <div class="mb-4">
                            ...
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                            <textarea name="sub_content_mm" id="sub_content_mm" class="border h-[200px] rounded w-full p-2 {{ $errors->has('sub_content_mm') ? 'border-red-500' : 'border-gray-300' }}">{{ old('sub_content_mm',$service->sub_content_mm) }}</textarea>
                        </div>
                    </div>
