    ...
    <div class="py-12">
        <div class="mx-auto max-w-5xl sm:px-6 lg:px-8">
            <div class="overflow-hidden rounded-lg bg-white shadow-sm">
                <div class="p-8">
                    <form action="{{ route('careers.store') }}" method="POST" enctype="multipart/form-data" id="careerForm" class="space-y-8" novalidate>
                        @csrf

                        <div>
                            <label for="title" class="mb-2 block text-sm font-semibold text-gray-800">Title</label>
                            <input type="text" name="title" id="title" maxlength="255" class="w-full rounded-lg border border-gray-300 p-3" value="{{ old('title') }}" required>
                            @error('title')
                        ...
                        <div>
                            ...
                            <input type="number" name="salary" id="salary" min="0" step="1" class="w-full rounded-lg border border-gray-300 p-3" value="{{ old('salary') }}" required>
                            @error('salary')
                                <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="space-y-6 border-t border-gray-200 pt-8">
                            <div>
                                ...
                                <textarea rows="10" name="ignite" id="ignite" class="w-full rounded-lg border border-gray-300 p-3" required data-required-message="The ignite field is required.">{{ old('ignite') }}</textarea>
                            ...
                            <div>
                                ...
                                <textarea rows="10" name="role" id="role" class="w-full rounded-lg border border-gray-300 p-3" required data-required-message="The role field is required.">{{ old('role') }}</textarea>
                        ...
                        <div class="space-y-6 border-t border-gray-200 pt-8">
                            ...
                            <div>
                                ...
                                <input type="text" name="title_mm" id="title_mm" maxlength="255" class="w-full rounded-lg border border-gray-300 p-3" value="{{ old('title_mm') }}">
                                @error('title_mm')
                                    <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <textarea rows="10" name="ignite_mm" id="ignite_mm" class="w-full rounded-lg border border-gray-300 p-3">{{ old('ignite_mm') }}</textarea>
                                @error('ignite_mm')
                                    <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <textarea rows="10" name="role_mm" id="role_mm" class="w-full rounded-lg border border-gray-300 p-3">{{ old('role_mm') }}</textarea>
                                @error('role_mm')
                                    <p class="mt-2 text-sm text-red-500">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="hidden" name="responsibilities_mm" id="responsibilities_mm" value="{{ old('responsibilities_mm') }}">
                            ...
                            <div>
                                ...
                                <input type="hidden" name="requirements_mm" id="requirements_mm" value="{{ old('requirements_mm') }}">
                            ...
                            <div>
                                ...
                                <input type="hidden" name="benefits_mm" id="benefits_mm" value="{{ old('benefits_mm') }}">
