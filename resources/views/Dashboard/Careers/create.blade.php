                    ...
                    <div class="mt-8 pt-6 border-t border-gray-200">
                        ...
                        <div class="mb-4">
                            ...
                            @error('ignite_mm')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                            <textarea rows="10" name="ignite_mm" id="ignite_mm" class="border rounded w-full p-2 {{ $errors->has('ignite_mm') ? 'border-red-500' : 'border-gray-300' }}">{{ old('ignite_mm') }}</textarea>
                        </div>
                        <div class="mb-4">
                            ...
                            @error('role_mm')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                            <textarea rows="10" name="role_mm" id="role_mm" class="border rounded w-full p-2 {{ $errors->has('role_mm') ? 'border-red-500' : 'border-gray-300' }}">{{ old('role_mm') }}</textarea>
                        </div>
                        <div class="mb-4">
                            ...
                            @error('responsibilities_mm')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                            <textarea name="responsibilities_mm" id="responsibilities_mm" class="border rounded w-full p-2 {{ $errors->has('responsibilities_mm') ? 'border-red-500' : 'border-gray-300' }}" placeholder="Use / between each item">{{ old('responsibilities_mm') }}</textarea>
                        </div>
                        <div class="mb-4">
                            ...
                            @error('requirements_mm')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                            <textarea name="requirements_mm" id="requirements_mm" class="border rounded w-full p-2 {{ $errors->has('requirements_mm') ? 'border-red-500' : 'border-gray-300' }}" placeholder="Use / between each item">{{ old('requirements_mm') }}</textarea>
                        </div>
                        <div class="mb-4">
                            ...
                            @error('benefits_mm')
                                <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                            @enderror
                            <textarea name="benefits_mm" id="benefits_mm" class="border rounded w-full p-2 {{ $errors->has('benefits_mm') ? 'border-red-500' : 'border-gray-300' }}" placeholder="Use / between each item">{{ old('benefits_mm') }}</textarea>
                        </div>
                    </div>
