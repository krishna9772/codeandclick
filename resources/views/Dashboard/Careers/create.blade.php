              ...
              <form action="{{ route('careers.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                     ...
                     <div class="mb-4">
                        ...
                        <select name="location" id="location" class="border border-gray-300 rounded w-full p-2" required>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="number" name="salary" id="salary" class="border border-gray-300 rounded w-full p-2" required>
                    </div>
                    <div class="mb-4">
                        <label for="ignite" class="block text-gray-700 font-bold mb-2">Ignite</label>
                        <textarea rows="10" name="ignite" id="ignite" class="border border-gray-300 rounded w-full p-2" required></textarea>
                    </div>
                    <div class="mb-4">
                        <label for="role" class="block text-gray-700 font-bold mb-2">Role</label>
                        <textarea rows="10" name="role" id="role" class="border border-gray-300 rounded w-full p-2" required></textarea>
                    </div>
                    <div class="mb-4">
